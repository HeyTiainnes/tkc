...
const GetUsers = () => {
    ...
    const fetchUsers = () => { // Fonction pour récupérer la liste des utilisateurs depuis l'API
        axios
            .get<User[]>("http://localhost:3010/theyUsers") // Requête HTTP GET vers l'API pour récupérer la liste des utilisateurs
    ...
    const deleteUser = (id: string) => { // Fonction pour supprimer un utilisateur de la liste
        axios
            .delete(`http://localhost:30010/theyUsers/${id}`) // Requête HTTP DELETE vers l'API pour supprimer l'utilisateur correspondant
